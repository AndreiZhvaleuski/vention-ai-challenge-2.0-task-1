...
const totalColSx = { display: { xs: 'none', sm: 'flex' }, flexDirection: 'column', alignItems: 'flex-end', minWidth: 56, width: 56 };
const totalLabelSx = { color: 'text.secondary', fontWeight: 600, letterSpacing: 0.5, lineHeight: 1.2, textAlign: 'right' };
const totalRowSx = { display: 'flex', alignItems: 'center', gap: 0.5, justifyContent: 'flex-end' };
